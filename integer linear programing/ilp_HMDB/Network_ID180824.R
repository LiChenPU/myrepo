...
#setwd("C:/Users/Li Chen/Dropbox/HRMass_ID/180629 Triwizard Tournament/Network_ID")
  #setwd("C:/Users/lc8/Dropbox/HRMass_ID/180629 Triwizard Tournament/Network_ID")
  #setwd("C:/Users/Li Chen/Desktop/Yihan/code")
...
df_raw = read_csv("neg_ecoli.csv")
df_raw = df_raw[df_raw$feature=="Metabolite",]
...
test=merge(raw, unknown_formula, by.x = "ID",by.y="id",all=T)
test=test[test$ILP_result==1,]
...
merge_edge_list = edge_list[edge_list$edge_massdif_score>0.9,]
