...
##Evaluation
{
  ...
  lin_result = lin_result[lin_result$feature=="Metabolite",]
  ...
  merge_Lin_ILP = merge(lin_result, test_formula, by.x="ilp_id",by.y="ID",all=T)
  ...
  edge_info_sum_debug = edge_info_sum[unique(c(which(edge_info_sum$formula1=="C21H33N1O24P2"),
                                               which(edge_info_sum$formula2=="C21H33N1O24P2"))),]
  edge_info_sum_debug2 = edge_info_sum[unique(c(which(edge_info_sum$formula1=="C10H16O15P2"),
                                               which(edge_info_sum$formula2=="C10H16O15P2"))),]
  edge_info_sum_debug3 = edge_info_sum[unique(c(which(edge_info_sum$formula1=="C21H30N7O17P3"),
                                                which(edge_info_sum$formula2=="C21H30N7O17P3"))),]
