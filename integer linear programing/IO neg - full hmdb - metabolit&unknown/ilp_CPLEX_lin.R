...
# C5_list = c()
# for(i in 1:nrow(merge_Lin_ILP_unknown_pred)){
#   if(elem_num_query(merge_Lin_ILP_unknown_pred$formula.y[i],"C")-merge_Lin_ILP_unknown_pred$C[i]==5){
#     if(elem_num_query(merge_Lin_ILP_unknown_pred$formula.y[i],"N")==merge_Lin_ILP_unknown_pred$N[i])
#     C5_list = c(C5_list,i)
#   }
# }
# merge_Lin_ILP_unknown_pred_C5 = merge_Lin_ILP_unknown_pred[C5_list,]